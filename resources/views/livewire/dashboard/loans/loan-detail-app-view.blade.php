<div class="relative min-h-screen">
    <div class="absolute inset-0 bg-center bg-cover opacity-50" style="background-image: url('public/minatas/img/fav.png');"></div>
    ...
    <div class="relative z-1 text-gray-800 bg-transparent dark:bg-gray-900 dark:text-gray-200 backdrop-blur-sm">
        <div class="max-w-6xl p-4 mx-auto">
            <nav class="mb-6 bg-white shadow p-3 rounded">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center space-x-4">
                            <img src="public/minatas/icon/loans.png" alt="Loan Type Icon" class="w-20 h-20 rounded-full">
                            <div>
                        ...
                        <div>
                            ...
                            <p class="text-sm">Status: 
                                <span class="font-semibold 
                                    {{ $loan->status == 0 ? 'text-warning' : '' }}
                                    {{ $loan->status == 1 ? 'text-success' : '' }}
                                    {{ $loan->status == 2 ? 'text-info' : '' }}
                                    {{ $loan->status == 3 ? 'text-danger' : '' }}
                                ">
                                    @if ($loan->status == 0)
