...
<div wire:ignore.self class="space-y-6">
    <div class="flex flex-wrap gap-4 mb-4">
        <div class="row g-3 needs-validation custom-input tooltip-valid validation-forms">
            <div class="col-md-4 position-relative">
                ...
                <select name="loan_type_id" id="loanType" class="block w-full border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm">
                    @if ($loan)
            ...
            <div class="col-md-4 position-relative">
                ...
                <select name="loan_child_type_id" id="loanCategory" class="block w-full border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm" disabled>
                    @if ($loan)
            ...
            <div  class="col-md-4 position-relative">
                ...
                <select name="loan_product_id" id="loanPackage" class="block w-full border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm" disabled>
                    @if ($loan)
        ...
        <div class="row g-3 needs-validation custom-input tooltip-valid validation-forms">
            <div  class="col-md-4 position-relative">
                ...
                <select name="amount" id="amount"  class="block w-full border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm">
                    @if ($loan)
            ...
            <div  class="col-md-4 position-relative">
                ...
                <select name="duration" id="duration" class="block w-full border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm">
                    @if ($loan)
            ...
            <div  class="col-md-4 position-relative">
                ...
                <input type="date" value="{{ auth()->user()->dob ?? '' }}" id="dob" name="dob" class="block w-full mt-1 border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm">
        ...
        <div class="row g-3 needs-validation custom-input tooltip-valid validation-forms">
            <div  class="col-md-4 position-relative">
                ...
                <div class="relative mt-1">
                    <input id="phone" value="{{ auth()->user()->phone }}" type="text" data-mask='0000 000 000' name="phone" class="block w-full border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm" placeholder="0977 --- ---">
                </div>
            ...
            <div  class="col-md-4 position-relative">
                ...
                <input value="{{ auth()->user()->occupation ?? auth()->user()->jobTitle }}" type="text" id="jobTitleInput" name="jobTitle" class="block w-full mt-1 border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm" placeholder="e.g., Teacher">
            ...
            <div  class="col-md-4 position-relative">
                ...
                <input value="{{ auth()->user()->employeeNo }}" type="text" id="employeeNo" name="employeeNo" class="block w-full mt-1 border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm" placeholder="Employee No." maxlength="8">
    ...
    <div class="row g-3 needs-validation custom-input tooltip-valid validation-forms">
        <div class="col-md-4 position-relative">
            ...
            <div class="flex mt-1 space-x-2">
                ...
                <input value="{{auth()->user()->nrc_no ?? auth()->user()->nrc}}" type="text" placeholder="ID Number" class="block w-full border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm" id="nrc" name="nrc">
            </div>
        ...
        <div  class="col-md-4 position-relative">
            ...
            <input value="{{ auth()->user()->ministry }}" placeholder="e.g., Ministry of Health" type="text" id="ministry" name="ministry" class="block w-full mt-1 border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm">
        </div>

        <div  class="col-md-4 position-relative">
            <label for="department" class="block text-sm font-medium text-blue-700">Department</label>
            <input value="{{ auth()->user()->department }}" type="text" id="department" name="department" class="block w-full mt-1 border-2 border-blue-500 rounded-md shadow-sm form-control focus:border-blue-700 focus:ring-blue-700 sm:text-sm" placeholder="Department">
        </div>
    </div>
    ...
    <div class="row g-3 needs-validation custom-input tooltip-valid validation-forms">
        <div  class="col-md-4 position-relative">
            ...
            <textarea id="address" name="address" cols="10" rows="2" class="block w-full mt-1 text-left border-gray-300 rounded-md shadow-sm form-control focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 sm:text-sm">{{ auth()->user()->address }}</textarea>
