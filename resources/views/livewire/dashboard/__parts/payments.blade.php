<style>
    ...
    .card {
        background: rgba(255, 255, 255, 0.1); /* Base color with transparency */
        background-image: linear-gradient(135deg, rgba(34, 193, 195, 0.5), rgba(253, 187, 45, 0.5)); /* Greenish gradient */
        backdrop-filter: blur(10px); /* Blurring effect */
        border-radius: 15px; /* Rounded corners */
        padding: 16px;
        box-shadow: rgba(0, 0, 0, 0.1) 0px 1px 2px 0px; /* Subtle shadow */
...
<div wire:ignore class="col-xl-12 col-md-12 col-sm-12">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8 p-2">
        ...
        <div class="animate-slide-fade card">
