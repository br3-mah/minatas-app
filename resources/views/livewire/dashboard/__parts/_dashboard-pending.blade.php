        ...
        <div class="relative flex px-10 mt-10">
            ...
            <div class="items-start justify-between p-4 md:flex-row gap-7">
                ...
                <div class="px-8 ml-4">
                    ...
                    <a href="#" class="shadow-lg inline-flex mt-6 px-4 align-middle bg-info border border-info rounded-full text-white transition-all duration-300 hover:bg-info/[0.85] hover:border-info/[0.85]">
