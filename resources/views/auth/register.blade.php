...
<html lang="en">
  <head>
    ...
    <title>SignUp || Minatas Loan App</title>
    <!-- Favicon icon-->
      ...
      <div class="m-0 row">
        <div class="p-0 col-12">    
          <div class="login-card login-dark">
            <div>
              <div>
                    <a class="text-center logo" href="{{ route('dashboard') }}">
              ...
              <div class="login-main"> 
                ...
                <x-jet-validation-errors class="p-4 mb-4 text-xs rounded float-alert-bar bg-danger" style="color:rgb(255, 255, 255)" />
                <form class="theme-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row g-2">
                        <div class="col-6">
                            <input class="form-control" name="fname" type="text" placeholder="" required>
                        </div>
                        <div class="col-6">
                            <input class="form-control" name="lname" type="text" placeholder="" required>
                        </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="phone" type="phone" name="phone" placeholder="" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="mb-0 form-group checkbox-checked">
                        <div class="form-check checkbox-solid-info">
                            <input class="form-check-input" name="terms" id="solid6" type="checkbox">
                            <label class="form-check-label" for="solid6">Agree with Terms</label>
                            {{-- <a class="ms-3 link" href="forget-password.html">Privacy Policy</a> --}}
                        </div>
                        <button class="mt-3 btn btn-primary btn-block w-100" type="submit">Create Account</button>
                    </div>
