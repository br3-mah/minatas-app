      ...
      onStepChanging: function (event, currentIndex, newIndex) {
        ...
        switch (currentIndex) {
          ...
          case 0:
              ...
              if( fname === '' || lname === '' || gender === '' || type === '' || duration === '' || phone === '' || amount === ''){
          ...
          case 1:
              if(type === 'Personal' || type === 'Home Improvement' || type === 'Vehicle' || type === 'Education'){
                ...
                if(nok_fname === '' || nok_lname === '' || validatenok_phone === '' || validatenok_gender === '' || validatenok_relation === ''){
                
                }else{
                  if(gfname === '' || glname === '' || gGender === '' || gRelation === '' || gPhone === '' || g2fname === '' || g2lname === '' || g2Gender === '' || g2Relation === '' || g2Phone === ''){
                    return !0;
                  }
                  return !0;
                }
