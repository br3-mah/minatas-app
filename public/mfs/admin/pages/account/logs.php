						...
						<div class="toolbar d-flex align-items-stretch">
							...
							<div class="container-xxl py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex justify-content-center flex-column me-5">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Logs & Notifcations</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
											...
											<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
												...
												<tbody>
													...
													<tr>
														...
														<!--end::Badge=-->
														<!--begin::Status=-->
														<td>POST /v1/invoices/in_6308_4713/payment</td>
														<!--end::Status=-->
														<!--begin::Timestamp=-->
													...
													<tr>
														...
														<!--end::Badge=-->
														<!--begin::Status=-->
														<td>POST /v1/customer/c_64b784bda5be6/not_found</td>
														<!--end::Status=-->
														<!--begin::Timestamp=-->
													...
													<tr>
														...
														<!--end::Badge=-->
														<!--begin::Status=-->
														<td>POST /v1/invoices/in_2771_7405/payment</td>
														<!--end::Status=-->
														<!--begin::Timestamp=-->
													...
													<tr>
														...
														<!--end::Status=-->
														<!--begin::Timestamp=-->
														<td class="pe-0 text-end min-w-200px">25 Jul 2023, 5:20 pm</td>
														<!--end::Timestamp=-->
													</tr>
													<!--end::Table row-->
													<!--begin::Table row-->
													...
													<tr>
														...
														<!--end::Badge=-->
														<!--begin::Status=-->
														<td>POST /v1/invoice/in_4294_6678/invalid</td>
														<!--end::Status=-->
														<!--begin::Timestamp=-->
													...
													<tr>
														...
														<!--end::Badge=-->
														<!--begin::Status=-->
														<td>POST /v1/customer/c_64b784bda5be7/not_found</td>
														<!--end::Status=-->
														<!--begin::Timestamp=-->
